...
const createAndBatchBuy = async (count: number, amount: number, fileName?: string, mintPath?: string) => {
    ...
    console.log("createAndBatchBuy start")
    ...
    const tokenMetadata = {
        name: 'TrueBliss',
        symbol: 'True',
        description: 'This is pump.fun token created by super TrueBliss using customized pump fun sdk',
        file: image,
...
createAndBatchBuy(1, 0.00001, "", "")
// batchSell('data_1745097558492.json', 'GdKDQPqhHMTXPr8pTTjtj9buEaqfsFkVqadP1t4M3i5y', new PublicKey('8asTAdsajGcbPthL1JnKx2Gk1EN7TD3VdvfySiZToQQG'))
// withdrawAllSol('data_1745097558492.json')
// withdrawLUT()