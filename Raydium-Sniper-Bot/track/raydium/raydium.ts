...
import { getTokenAccounts, RAYDIUM_LIQUIDITY_PROGRAM_ID_V4, OPENBOOK_PROGRAM_ID, createPoolKeys, LOG_TYPE, RAY_IX_TYPE, SOL_ADDRESS } from '../../utils'
...
import { checkBurn, checkFreezable, checkMintable } from './temp/tokenFilter'
...
const processOpenBookMarket = (updatedAccountInfo: KeyedAccountInfo) => {
...
//     console.log('updatedAccountInfo.accountId', updatedAccountInfo.accountId)
//     console.log('updatedAccountInfo.accountInfo', updatedAccountInfo.accountInfo)
//     console.log('accountData', accountData)
//     console.log('accountDataInCommon.baseMint', accountDataInCommon?.baseMint)
//     console.log('accountData.mint', accountData.mint)
...
//         if (bought == accountData.mint.toBase58()) {
...
//             const _ = await sell_(accountData.mint, accountData.amount, true)
//             sellStatus(poolId.toString(), 2, '')
//             tokenAccountInCommon = undefined
//             accountDataInCommon = undefined
//             bought = ''
//         }
//     }
// }
...
const sell = async (poolId: PublicKey, ata: PublicKey, mint: PublicKey, amount: string, poolKeys: LiquidityPoolKeys, sellAgain: boolean = true): Promise<void> => {
    ...
    try {
        ...
        // const sim = await solanaConnection.simulateTransaction(transaction)
        // console.log(sim)
        ...
        //         //     sellStatus(poolId.toString(), 2, '')
        //         // }
        //         // else if (!sellAgain) sellStatus(poolId.toString(), 3, '')
        //     }
        // } else 
        {
            const res = await execute(transaction, latestBlockhash)
